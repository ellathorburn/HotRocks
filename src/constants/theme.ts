...
export const Colors = {
  light: {
    ...
    // Darker than cedar700 so error text and hot badges reach WCAG AA (4.5:1).
    cedar: '#8E4526',
    hot: palette.ember500,
    cold: palette.ice400,
    // ice600 measured 3.96:1 on linen; this shade reaches 5.7:1.
    coldInk: '#3B6480',
    iceTint: palette.ice100,
    rest: palette.indigo600,
    restInk: palette.linen100,
    restTint: '#DEDEEA',
  ...
  dark: {
    ...
    // indigo400 measured 3.98:1 on dark cards; this reaches 5.1:1.
    ...
    accentTint: '#3A2038',
    sand: palette.sand400,
    // cedar700 measured 3.18:1 on midnight; errors use a light terracotta.
    cedar: '#E8916F',
    hot: palette.ember500,
    cold: palette.ice400,
